    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          <img src={logo} alt="El May Djerba Immo" className="h-16 w-16 mx-auto mb-2 object-contain" />
          <CardTitle className="font-heading text-xl">Espace Admin</CardTitle>
          <p className="text-sm text-muted-foreground">El May Djerba Immo</p>
        </CardHeader>
        <CardContent>
  ...
  const handleAdd = async (form: PropertyForm) => {
    try {
      await addProperty({
        ...
        price_nightly: form.price_nightly ?? null,
      ...
      <header className="bg-card border-b border-border sticky top-0 z-50">
        <div className="container mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={logo} alt="El May Djerba Immo" className="h-8 w-8 object-contain" />
